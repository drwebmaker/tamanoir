...
define(function (require) {
    var Backbone = require('backbone'),
        ...
        ConnectionListItemView = require('view/connections/ConnectionListItemView'),
        ConnectionModel = require('model/ConnectionModel'),
        ConnectionsCollection = require('collection/ConnectionsCollection'),
        ConnectionsViewTemplate = require('text!template/connections/ConnectionsViewTemplate.html');

    require('css!styles/connections/connections');
    ...
    return Backbone.View.extend({
        ...
        render: function () {
            this.$el.html(ConnectionsViewTemplate);
