...
define(function (require) {
    var Backbone = require('backbone'),
        ...
        ConnectionListItemView = require('home/view/ConnectionListItemView'),
        ConnectionsListViewTemplate = require('text!home/template/ConnectionsListViewTemplate.html');
