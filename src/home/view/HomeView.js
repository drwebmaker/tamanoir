...
define(function (require) {
    var Backbone = require('backbone'),
        $ = require('jquery'),
        HomeViewTemplate = require('text!home/template/HomeViewTemplate.html'),
        ConnectionsListView = require('home/view/ConnectionsListView'),
        DomainsListView = require('home/view/DomainsListView'),
        PostgreSQLConnectionModel = require('common/model/PostgreSQLConnectionModel'),
        EditDomainView = require('home/view/EditDomainView'),
        EditConnectionView = require('home/view/EditConnectionView');
